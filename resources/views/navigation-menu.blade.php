<nav x-data="{ open: false }" class="bg-white  border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="px-12 pb-2 border-t border-gray-200">
            <div class="flex items-right px-1">
                @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                ...
                <div>
                    ...
                    {{-- <div class="font-medium text-sm text-gray-500">
                       ...
                       @else   <x-responsive-nav-link href="{{ route('login') }}" :active="request()->routeIs('profile.show')">
                        {{ __('Login') }}
                    </x-responsive-nav-link> 
